...
st.image("banner.png", width="stretch")  # 원본 유지: 최신 Streamlit의 올바른 문법
...
with tab3:
    ...
    for i in range(len(SUBJECTS)):
        ...
        with cols[i]:
            ...
            st.write(f"평균: {subject_average(students, subject)}")  # FIX: str + float -> f-string
...
with tab4:
    ...
    st.header("학점 분포")
    dist = grade_distribution(students)  # FIX: studets -> students (오타)
